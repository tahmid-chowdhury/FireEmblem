...
public class Units {
	...
	public static class winterRanger extends BaseMechanics.Unit{
		public winterRanger(){
			this.sprites = new BufferedImage[2];
			this.speed = 3.5;
			this.type = Unit.Type.RANGED;
			...
			this.armour = 1;
			try{
				sprites[1] = ImageIO.read(new File("sprites/characters/heads/fhead7.png"));
				sprites[0] = ImageIO.read(new File("sprites/characters/body/fbody7.png"));
			}catch(Exception e){
